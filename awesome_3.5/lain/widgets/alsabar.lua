...
local alsabar = {
    ...
    mixer    = terminal .. " -e alsamixer -c 1",
...
local function worker(args)
    ...
    function alsabar.update()
        ...
        local f = io.popen("amixer -c 1 -M get " .. alsabar.channel)
    ...
    alsabar.bar:buttons (awful.util.table.join (
          ...
          awful.button ({}, 3, function()
            awful.util.spawn(string.format("amixer -c 1 set %s toggle", alsabar.channel))
            alsabar.update()
          end),
          awful.button ({}, 4, function()
            awful.util.spawn(string.format("amixer -c 1 set %s %s+", alsabar.channel, alsabar.step))
            alsabar.update()
          end),
